...
//   state = {
//     searchInput: '',
//     userListDetails: initialHistoryList,
//   }
...
//   render() {
//     const {searchInput, userListDetails} = this.state
//     const searchResult = userListDetails.filter(eachUser =>
...
//               <li key={eachObject.id} className="list-container">
...
//                     alt="domain logo"
//                   />
//                   <p className="title">{eachObject.title}</p>
//                   <p className="title-site">{eachObject.domainUrl}</p>
//                 </div>
